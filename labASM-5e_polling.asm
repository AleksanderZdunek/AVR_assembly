;
; LabASM-5e_polling.asm
; Send and receive on serial interface
; UART Universal Asynchronous Receiver Transmitter
; with Rx polling and long delay
;
; Created: 2026-02-22 15:43:50
; Author : aleksander
;
...
init_uart:
	...
	rcall salute
	//sei //set SREG interrupt bit (SREG_I) to enable interrupt handling //interrupt handling disabled
main_loop:
	rcall uart_get_char //polling of Rx
	sbis PINB, BTN2
	rcall uart_send_str
	rcall longdelay
	rjmp main_loop
...
uart_get_char_inter:
	...
	in tmp, SREG
	push tmp
	rcall uart_get_char //do the thing
	pop tmp
	out SREG, tmp
	pop tmp
	reti
...
longdelay:
	ldi r22, 60 //approximately 3 seconds
	longdelay_loop:
		rcall delay50ms
		dec r22
		brne longdelay_loop
...
msg: .db "LabASM-5e with long delay and Rx polling", '\n', '\r', 0
